    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-2 sm:px-3 md:px-4 py-10 sm:py-14 md:py-20 relative overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-10 lg:gap-12 relative z-10">
        ...
        >
          ...
          {/* Card Container */}
          <div className="backdrop-blur-xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/40 rounded-lg sm:rounded-2xl md:rounded-3xl px-3 sm:px-4 md:px-8 lg:px-10 py-4 sm:py-5 md:py-8 lg:py-10 w-full flex flex-col items-center gap-2 sm:gap-2.5 md:gap-4 shadow-xl">
            ...
            <a href="/Mahia_Akter_Momo_resume.pdf" target="_blank" rel="noopener noreferrer" className="px-2 sm:px-3 md:px-5 lg:px-6 py-1 sm:py-1.5 md:py-2.5 lg:py-3 rounded-full bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-heading font-semibold text-xs sm:text-sm hover:shadow-lg hover:shadow-primary/50 transition-all flex items-center justify-center gap-0.5 sm:gap-1 md:gap-2">
        ...
        >
          ...
          <p className="text-muted-foreground text-xs sm:text-sm md:text-base max-w-lg mb-4 sm:mb-5 md:mb-6 lg:mb-8 leading-relaxed px-1 sm:px-0 text-center md:text-left">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 md:flex md:flex-wrap gap-2 sm:gap-3 md:gap-5 lg:gap-8 mb-4 sm:mb-5 md:mb-6 lg:mb-8 px-1 sm:px-0 w-full md:w-auto justify-center md:justify-start">
          ...
          <div className="flex flex-col sm:flex-row gap-1.5 sm:gap-2 md:gap-3 px-1 sm:px-0 w-full md:w-auto justify-center md:justify-start">
            <a href="#contact" className="px-3 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2.5 lg:py-3 rounded-lg bg-primary text-primary-foreground font-heading font-medium text-xs sm:text-sm hover:opacity-90 transition-opacity text-center flex-1 sm:flex-initial">
              Let's Talk
            </a>
            <a href="#projects" className="px-3 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2.5 lg:py-3 rounded-lg border border-border text-foreground font-heading font-medium text-xs sm:text-sm hover:bg-secondary transition-colors text-center flex-1 sm:flex-initial">
              My Work →
            </a>
          </div>
        </motion.div>
